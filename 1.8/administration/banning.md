...
To ban registered user you need to fill following fields:
...
#### Editing or Removing Ban for Account

You can remove ban for some account by selecting **Lift** option under *Controls* section. Also, you can edit ban reason or expand ban by selecting **Edit** option under *Controls* section.

#### Pruning Threads & Posts

You can prune (delete) all threads and posts by specific user by selecting **Prune Threads & Posts** under *Moderation* section.
...
To ban a username, simply fill in the desired username to be banned in the form at the bottom of the page and select "Disallow Username." Be aware that partial matches are disallowed, so any username containing the disallowed username will not be able to be registered.
...
**Please note:** If you would like to have any email addresses that you disallow through the Admin CP to no longer be used by existing users, you must set "Users Keep Email" under "User Registration and Profile Options" to No.

#### Disallowing Email Addresses

To ban an email address or email address domain, simply fill in the desired email address or domain to be banned in the form at the bottom of the page and select "Disallow Email Address."
