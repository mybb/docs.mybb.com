...
- **bin/** &mdash; executable files
  - **cli** &mdash; command line interface executable
...
- **inc/** &mdash; source code files _(internal)_
  - **3rdparty/** &mdash; external libraries
  - **languages/** &mdash; language pack directories
    - `LANGUAGE-NAME/` &mdash; phrase files of a language pack
    - `LANGUAGE-NAME.php` &mdash; metadata file for a language pack
  - **plugins/** &mdash; plugin source code files
  - **schemas/** &mdash; database definition files
  - **seeds/** &mdash; initial data
  - **src/** &mdash; modern source code files
  - **tasks/** &mdash; task files
  - **themes/** &mdash; Theme packages
  - **upgrades/** &mdash; upgrade files
  - **vendor/** &mdash; external libraries included through Composer
  - **views/** &mdash; system Twig templates
...
- **.htaccess** &mdash; server rules related to redirects and security features (Apache servers only)
